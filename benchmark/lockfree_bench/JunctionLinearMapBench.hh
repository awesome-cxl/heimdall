#ifndef CXLBENCH_JUNCTION_LINEARMAP_H
#define CXLBENCH_JUNCTION_LINEARMAP_H
...
template <> class CXLBench<junction::ConcurrentMap_Linear<uint64_t, uint64_t>> {
private:
  junction::ConcurrentMap_Linear<uint64_t, uint64_t> *m;
  size_t size;
