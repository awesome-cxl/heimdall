#ifndef CXLBENCH_LIBCDS_SKIPLISTMAP_H
#define CXLBENCH_LIBCDS_SKIPLISTMAP_H
...
template <>
class CXLBench<cds::container::SkipListMap<cds::gc::HP, uint64_t, uint64_t>> {
private:
  cds::container::SkipListMap<cds::gc::HP, uint64_t, uint64_t> *m;
  size_t size;
